...
public class SubBudgetFragment extends Fragment {
    private PieChart mChart;

    public SubBudgetFragment(){

    }

    public static SubBudgetFragment newInstance(){
        SubBudgetFragment fragment = new SubBudgetFragment();
        return fragment;
    }
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_sub_buget, container, false);
        init(view);
        return view;
    }
