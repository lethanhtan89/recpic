...
public class TotalBudgetFragment extends Fragment implements SeekBar.OnSeekBarChangeListener, OnChartValueSelectedListener{
    ...
    public static TotalBudgetFragment newInstance(){
        TotalBudgetFragment fragment = new TotalBudgetFragment();
        return  fragment;
    }
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup parent, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_total_budget, parent, false);
        init(view);
        return view;
    }
