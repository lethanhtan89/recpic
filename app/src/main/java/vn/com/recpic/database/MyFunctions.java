...
public class MyFunctions {
    ...
    private static final String loginUrl = "http://192.168.10.100/web_android/index.php";
    private static final String regiterUrl = "http://192.168.10.100/web_android/index.php";
